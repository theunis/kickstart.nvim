...
-- Keybinding to select a Jupyter connection file
vim.api.nvim_set_keymap('n', '<leader>jc', ':lua require("jupyter_connection").select_connection_file()<CR>', { noremap = true, silent = true })

-- Keybinding to initialize Molten with the selected connection file
vim.api.nvim_set_keymap('n', '<leader>jm', ':lua require("jupyter_connection").init_molten()<CR>', { noremap = true, silent = true })

-- Move x and c deleted text to black hole register
vim.keymap.set('n', 'x', '"_x')

-- Same for dd, but only when it's a blank line
...
vim.keymap.set('o', 'aa', "<Cmd>lua require'nvim-treesitter.textobjects.select'.select_textobject('@parameter.outer', 'textobjects', 'o')<CR>")
vim.keymap.set('o', 'ia', "<Cmd>lua require'nvim-treesitter.textobjects.select'.select_textobject('@parameter.inner', 'textobjects', 'o')<CR>")

vim.keymap.set('n', '<leader>a', "<Cmd>lua require'nvim-treesitter.textobjects.swap'.swap_next('@parameter.inner')<CR>")
vim.keymap.set('n', '<leader>A', "<Cmd>lua require'nvim-treesitter.textobjects.swap'.swap_previous('@parameter.inner')<CR>")
